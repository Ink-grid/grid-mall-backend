...
var Provider = /** @class */ (function () {
    function Provider(provider) {
        this.query = new Querys_1.default('providers');
    ...
    Provider.prototype.getProvider = function (doc) {
        return __awaiter(this, void 0, void 0, function () {
            var provider;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    Provider.prototype.setProvider = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            var uid;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.query.addItem(data || this.provider)];
                    case 1:
                        uid = _a.sent();
                        return [4 /*yield*/, this.query.setItemsUid(uid.id, 'ruc')];
                    case 2:
                        _a.sent();
    ...
    Provider.prototype.deleteProvider = function (doc) {
        return __awaiter(this, void 0, void 0, function () {
            var error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    Provider.prototype.updateProviders = function (doc, data) {
        return __awaiter(this, void 0, void 0, function () {
            var error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
